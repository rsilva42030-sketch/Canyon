(function () {
  ...
  function renderHome() {
    outlet.innerHTML =
      '<section id="hero"><div class="hero-content"><div class="hero-image-wrapper animate-in-scale"><img src="assets/images/hero.svg" alt="Canyon" class="hero-image" loading="eager"></div><div class="hero-headline-group"><h1 class="hero-title">Engineered to Perform</h1><p class="hero-subtitle">Bicicletas de classe mundial. Direto a ti.</p><div class="hero-cta"><a href="#/shop" class="btn">Explorar Modelos</a></div></div></div><div class="scroll-indicator" aria-hidden="true"><div class="scroll-chevron"></div></div></section>' +
